...
public class ObjectFactory {
    ...
    private final static QName _Execute_QNAME = new QName("http://bsg.gob.ec/AccesoBSGService", "execute");
    private final static QName _ExecuteResponse_QNAME = new QName("http://bsg.gob.ec/AccesoBSGService", "executeResponse");
    ...
    /**
     * Create an instance of {@link RetornoOne }
     * 
     */
    public RetornoOne createRetornoOne() {
        return new RetornoOne();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bsg.gob.ec/AccesoBSGService", name = "execute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bsg.gob.ec/AccesoBSGService", name = "executeResponse")
